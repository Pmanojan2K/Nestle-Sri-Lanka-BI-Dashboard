...
<body>
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="breadcrumb-wrap mb-g">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-6">
                                <ul class="breadcrumb">
                                    <li><a href="index1.php"><i class="bi bi-house-door-fill"></i> Ecommerce</a></li>
                    ...
                    <div class="panel mb-g">
                        <div class="panel-heading" style="display: flex; align-items: center;">
                            <div style="flex-grow: 1;">
                                <h2 style="margin: 0;">Manager Promotion</h2>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <h4>Promoted</h4>
                                    <div id="left" class="dragula-box">
                                        <div class="card bg-light bg-primary"><img src="../assets/images/ds-manager/sundar.jpg" alt="Sundar" width="120px" height="120px" style="display: block; margin: 0 auto;"><br>
                                            <p style="text-align:center; font-size:25px;">Vavuniya District</p>
                                        </div>
                                        <div class="card bg-light bg-primary"><img src="../assets/images/ds-manager/mark.jpeg" alt="Mark" width="120px" height="120px" style="display: block; margin: 0 auto;"><br>
                                            <p style="text-align:center; font-size:25px;">Mullaitheevu District</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <h4>Ongoing</h4>
                                    <div id="center" class="dragula-box">
                                        <div class="card bg-light bg-warning"><img src="../assets/images/ds-manager/steeve.jpeg" alt="Jone" width="120px" height="120px" style="display: block; margin: 0 auto;"><br>
                                            <p style="text-align:center; font-size:25px;">Mannar District</p>
                                        </div>
                                        <div class="card bg-light bg-warning"><img src="../assets/images/ds-manager/bill.jpeg" alt="Bill" width="120px" height="120px" style="display: block; margin: 0 auto;"><br>
                                            <p style="text-align:center; font-size:25px;">Jaffna District</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <h4>Hold</h4>
                                    <div id="right" class="dragula-box">
                                        <div class="card bg-light bg-danger"><img src="../assets/images/ds-manager/elan.jpeg" alt="Musk" width="120px" height="120px" style="display: block; margin: 0 auto;"><br>
                                            <p style="text-align:center; font-size:25px;">Mullaitheevu District</p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12">
                    <div class="panel mb-g">
                        <div class="panel-heading" style="display: flex; align-items: center;">
                            <div style="flex-grow: 1;">
                                <h2 style="margin: 0;">Promotion Statics</h2>
                            </div>
                        </div>
                        <div class="panel-body">
    ...
    <script src="../assets/vendor/js/sweetalert.min.js"></script>
    <script src="../assets/vendor/js/toastify-js.js"></script>
    <script src="../assets/vendor/js/bootstrap.bundle.min.js"></script>
    <script src="../assets/vendor/js/dragula.min.js"></script>
    <script src="../assets/vendor/js/bs-dropzone.min.js"></script>
    <script src="../assets/js/main.js"></script>
    <script src="../assets/js/toastify-init.js"></script>

    <!-- Code for promotion chart -->
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <script src="../assets/js/chart/stack-promot.js"></script>
