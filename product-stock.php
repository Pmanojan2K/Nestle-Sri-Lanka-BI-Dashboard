...
<body>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12">
                    <div class="panel mb-g">
                        <div class="panel-heading" style="display: flex; align-items: center;">
                            <div style="flex-grow: 1;">
                                <h2 style="margin: 0;">Stock Turnover</h2>
                            </div>
                        </div>
                        <div class="panel-body" style="max-width: 1300px;">
    ...
    <script src="../assets/js/chart/stock-analy.js"></script>

    <!-- Chart for stock income -->
    <script src="node_modules/chart.js/dist/Chart.min.js"></script>
    <script src="../assets/js/chart/stock-line.js"></script>
