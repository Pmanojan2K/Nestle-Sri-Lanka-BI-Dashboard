...
<body>
        ...
        <div class="main-content">
                    ...
                    <div class="panel mb-g">
                        <div class="panel-body">
                            <div class="sale-top-box">
                                ...
                                <div class="part-txt">
                                    <h5><span>Average age products</span> 11</h5>
                                    <p>in Jaffna</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel mb-g">
                        <div class="panel-body">
                            <div class="sale-top-box">
                                ...
                                <div class="part-txt">
                                    <h5><span>Average purchases</span> 184,575</h5>
                                    <p>in Jaffna</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel mb-g">
                        <div class="panel-body">
                            <div class="sale-top-box">
                                ...
                                <div class="part-txt">
                                    <h5><span>Average Incomes</span> 168,846</h5>
                                    <p>in Jaffna</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="panel mb-g">
                        <div class="panel-heading">
                            <h3>Customer purchasing products by age</h3>
                        </div>
                        <div class="panel-body">
                                        ...
                                        if ($result) {
                                            ...
                                            echo '<thead style="text-align: center;">
                                                            <tr>
                                                                ...
                                                                <th>Average Age of Products</th>
                                                                <th colspan="2" style="text-allign:center;">Buttons</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>';
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                echo '<tr style="text-align: center;">
                                                            ...
                                                            <td>' . $row['Shop_Type'] . '</td>
                                                            <td>' . $row['District'] . '</td>
                                                            <td>' . $row['No_Ordered_Products'] . '</td>
                                                            <td>' . $row['Ave_age_products'] . '</td>
                                                            <td>
                    ...
                    <div class="panel mb-g">
                        ...
                        <div class="panel-body">
                            <div class="user-feedback">
                                <div class="table-responsive">
                                    <?php
                                    $connection = new mysqli("localhost", "root", "root", "bi_assignment");
                                    ...
                                    $result = $connection->query("SELECT Customer_Name, District, Email_Address, Feedback, Date FROM feedback_details");
                                    ...
                                    if ($result) {
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo '<td>' . $row['Date'] . '</td>';
                                                echo '<td>
                                                                <a href="#"><button class="btn btn-sm btn-primary"><i class="bi bi-chat-right-text-fill"></i></button></a>
                                                            </td>
                                                            <td>
                                                                <button class="btn btn-sm btn-danger"><i class="bi bi-x-circle"></i></button>
                                                            </td>';
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12">
                    <div class="panel mb-g">
                        <div class="panel-heading">
                            <h3>User Feedback Summery Status</h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
    ...
    <script src="../assets/js/finance-page-chart.js"></script>


    <!-- Customer feedback status -->
    <script src="../assets/js/chart/hori-bar.js"></script>
    ...
    <script src="../assets/js/chart/canvas-js.js"></script>
