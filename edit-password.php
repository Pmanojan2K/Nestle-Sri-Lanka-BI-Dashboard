                            ...
                            <form>
                                <div class="mb-17">
                                    ...
                                    <div class="form-group has-icon-left">
                                        <input type="password" class="form-control form-control-lg" id="oldPassword" placeholder="Old Password" readonly>
                                ...
                                <div class="mb-15">
                                    ...
                                    <div class="form-group has-icon-left">
                                        <input type="password" class="form-control form-control-lg" id="newPassword" placeholder="Password">
                                        <div class="form-control-icon">
                                            <i class="bi bi-key-fill"></i>
                                        </div>
                                    </div>
