...
<body>
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="breadcrumb-wrap mb-g">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-6">
                                <ul class="breadcrumb">
                                    <li><a href="index1.php"><i class="bi bi-basket2-fill"></i> Ecommerce</a></li>
                    ...
                    <div class="panel mb-g">
                        <div class="panel-heading" style="display: flex; align-items: center;">
                            ...
                            <div style="margin-left: auto;">
                                <form class="nav-form d-flex" method="post">
                                    <input type="search" placeholder="Type to search here" name="searchtext" aria-label="Search" style="width:350px;">
                                    <button type="submit" name="search" style="border:2px"><i class="bi bi-search"></i></button>
                                </form>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="table data-table">
                                        ...
                                        if (isset($_POST['search'])) {
                                            ...
                                            if (!empty($searchtext)) {
                                                // Query to fetch data from the order_details table based on the selected search text
                                                $sql = "SELECT Order_ID, Product_Name, Quantity, Product_Price, Order_Date, Status, District FROM order_details WHERE Order_ID='$searchtext' OR Product_Name='$searchtext' OR Quantity='$searchtext' OR Product_Price='$searchtext' OR District='$searchtext'";
                                            ...
                                            // Query to fetch all data from the order_details table
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12">
                    <div class="panel mb-g">
                        <div class="panel-heading" style="display: flex; align-items: center;">
                            <div style="flex-grow: 1;">
                                <h2 style="margin: 0;">Order Analysis</h2>
                            </div>
                            <div style="margin-left: auto;">
                                <select id="districtSelect2">
    ...
    <script src="../assets/js/chart/stock-hor.js"></script>

    <!-- Code for request order chart -->
    <script src="../assets/js/chart/chart-order-req.js"></script>
