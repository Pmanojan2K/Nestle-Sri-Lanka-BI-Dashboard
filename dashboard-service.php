...
<body>
            ...
            <div class="top-box">
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-sm-6">
                        <div class="single-box bg-info mb-g">
                            <div class="part-icon">
                                <i class="bi bi-envelope"></i>
                            </div>
                            <div class="part-txt">
                                <p><span>New</span> Orders</p>
                                <h3>113800000</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-sm-6">
                        <div class="single-box bg-success mb-g">
                            <div class="part-icon">
                                <i class="bi bi-chat-text"></i>
                            </div>
                            <div class="part-txt">
                                <p><span>New</span> Reviews</p>
                                <h3>71920000+</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-sm-6">
                        <div class="single-box bg-danger mb-g">
                            <div class="part-icon">
                                <i class="bi bi-credit-card"></i>
                            </div>
                            <div class="part-txt">
                                <p><span>Today</span> Earnings</p>
                                <h3>Rs 2900000</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-sm-6">
                        <div class="single-box bg-warning mb-g">
                            <div class="part-icon">
                                <i class="bi bi-people"></i>
                            </div>
                            <div class="part-txt">
                                <p><span>New</span> Customers</p>
                                <h3>1118000</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel mb-g">
                        <div class="panel-heading" style="display: flex; align-items: center;">
                            <div style="flex-grow: 1;">
                                <h2 style="margin: 0;">Revenue details</h2>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div id="grouped-barchart1"></div>
                        </div>
                        <div class="panel-body">
                            <div id="grouped-barchart2"></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="../assets/js/service-page-chart.js"></script>

    <!-- Code for horizontal barchart -->
    ...
    <script src="https://cdn.amcharts.com/lib/5/percent.js"></script>
    <script src="https://cdn.amcharts.com/lib/5/themes/Animated.js"></script>
    <script src="../assets/js/3d-chart.js"></script>

    <!-- New pie chart for customer feedback -->
