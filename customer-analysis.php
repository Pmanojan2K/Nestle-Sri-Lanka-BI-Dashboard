...
<body>
                    ...
                    <div class="panel mb-g">
                        <div class="panel-heading" style="display: flex; align-items: center;">
                            <div style="flex-grow: 1;">
                                <h2 style="margin: 0;">Population statistics</h2>
                            </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12">
                    <div class="panel mb-g">
                        <div class="panel-heading" style="display: flex; align-items: center;">
                            <div style="flex-grow: 1;">
                                <h2 style="margin: 0;">Review statistics</h2>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div style="margin-left: auto;">
    ...
    <!-- Code for split pie chart-->
    <script src="https://cdn.jsdelivr.net/npm/apexcharts@3.27.0/dist/apexcharts.min.js"></script>
    <script src="../assets/js/chart/split-pie.js"></script>

    <!--Code for bar chart-->
    <script src="https://cdn.jsdelivr.net/npm/apexcharts@latest"></script>
    <script src="../assets/js/chart/populat-bar-new.js"></script>
