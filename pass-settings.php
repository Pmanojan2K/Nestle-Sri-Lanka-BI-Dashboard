...
<head>
    ...
    <!-- Code for password edite formating -->
    <style>
        .panel-body {
            display: flex;
        ...
        .centered-panel {
            ...
            /* Updated padding values: top right bottom left */
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="breadcrumb-wrap mb-g">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-6">
                                <ul class="breadcrumb">
                                    <li><a href="index1.php"><i class="bi bi-gear-fill"></i>Settings</a></li>
                            ...
                            <div class="centered-panel">
                                <form method="post">
                                    <div class="row mb-15">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control form-control-lg" id="username" placeholder="Enter the username" required>
                                        </div>
                                    </div>
                                    <div class="row mb-15">
                                        <label for="oldpass" class="col-sm-4 col-form-label">Old Password</label>
                                        <div class="col-sm-8">
                                            <input type="password" class="form-control form-control-lg" id="oldpass" placeholder="Old Password" readonly>
                                        </div>
                                    </div>
                                    <div class="row mb-15">
                                        <label for="newpass" class="col-sm-4 col-form-label">New Password</label>
                                        <div class="col-sm-8">
                                            <input type="password" class="form-control form-control-lg" id="newpass" placeholder="Enter the new Password" required>
                                        </div>
                                    </div>
                                    <div class="row mb-15">
                                        <label for="renewpass" class="col-sm-4 col-form-label">Re-enter the Password</label>
                                        <div class="col-sm-8">
                                            <input type="password" class="form-control form-control-lg" id="renewpass" placeholder="Re-enter the new Password" required>
                                        </div>
                                    </div>
                                    <div class="row mb-15">
                                    ...
                                    <div class="btn-box d-flex justify-content-center mt--3" style="text-align: center;">
                                        <button type="submit" class="btn btn-lg btn-primary" style="width: 200px;">Update</button>
                                        <button type="reset" class="btn btn-lg btn-danger" style="width: 200px;">Clear</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<?php
echo "<script>
        // Show/hide password when the checkbox is clicked
        var showPasswordCheckbox = document.getElementById('showPassword');
        var newPasswordInput = document.getElementById('newpass');
        var reenterPasswordInput = document.getElementById('renewpass');
        ...
        // Validate passwords when the form is submitted
